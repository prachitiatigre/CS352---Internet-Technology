...
def send_reliable(cs, filedata, receiver_binding, win_size):
    ...
    # first_to_tx:
    # first_to_tx is the first “fresh” sequence number that the sender 
    # must transmit. It is defined as 1 + the latest sequence number that the sender has transmitted 
    # (i.e., the right edge of its window) so far.
